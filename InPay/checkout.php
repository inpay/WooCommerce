    ...
    function declareWooInpay () {
        ...
        class WC_Inpay extends WC_Payment_Gateway {
            ...
            function process_payment ($order_id) {
                ...
                $redirect = add_query_arg('key', $order->order_key, add_query_arg('order-received', $order_id, $thanks_link));
                ...
                $invoice = bpCreateInvoice($order->order_total, $order_id, $options);
